...
class MineCraftCorner(AbstractBuilder):
    ...
    def __init__(self, match_shape, visual_shape):
        super().__init__(match_shape, visual_shape)
        normal_tiles = [
            VolumeTexture("roof",
                          roof(match_shape),
                          roof(visual_shape),
        ...
        rotated_tiles = [
            ...
            #               ["wall", "closed", "inside", "boundary", "straight"],
            #              {"y": "front_wall_inside"}
            #              ),
            ...
            #               floor(visual_shape),
            #               ["wall", "closed", "inside", "door",  "routing", "straight"],
            ...
            #               ["wall", "door", "routing", "boundary", "straight"],
            #              {"y": "front_wall_with_door_opening_boundary"}
            #              ),
            # super().VTOM("front_wall_with_window_boundary",
            #               front_wall_with_window(visual_shape) +
            #               floor_for_wall_between_inside_outside(visual_shape),
            #               ["wall", "window", "boundary"],
            #              {"y": "front_wall_with_window_boundary"}),
